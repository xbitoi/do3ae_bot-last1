...
def render_guide():
    ...
    <div class="card" style="direction: rtl;">
        ...
        <ul style="margin-right: 20px;">
            <li><b>Tajawal</b> - خط تجوال عصري ورفيع</li>
            <li><b>Almarai</b> - خط المراعي كلاسيكي وواضح</li>
            <li><b>Lalezar</b> - خط لاله زار عريض وبارز</li>
            <li><b>Changa</b> - خط شانجا قوي ومميز</li>
            <li><b>Reem Kufi</b> - خط ريم كوفي هندسي</li>
        </ul>
